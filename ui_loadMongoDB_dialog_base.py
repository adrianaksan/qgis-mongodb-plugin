...
class Ui_loadMongoDBDialogBase(object):
    def setupUi(self, loadMongoDBDialogBase):
        ...
        self.query_field = QtGui.QComboBox(self.layoutWidget)
        ...
        self.load_collection.setGeometry(QtCore.QRect(140, 20, 114, 32))
    ...
    def retranslateUi(self, loadMongoDBDialogBase):
        ...
        self.label.setText(_translate("loadMongoDBDialogBase", "MongoDB Loadeeer", None))
